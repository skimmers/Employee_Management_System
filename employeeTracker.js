...
function mainMenu() {
    ...
    inquirer
        ...
        .then((answer) => {
            ...
            // Switch case depending on user answer
...
function viewAllEmpByDept() {
    ...
    // Create new connection using promisesql
        ...
        .then((conn) => {
            ...
            inquirer.prompt({
                ...
                .then((answer) => {
                    ...
                    const query = `SELECT e.id, e.first_name, e.last_name, role.title, department.name AS department, role.salary, concat(m.first_name, ' ' ,  
                    m.last_name) AS manager FROM employee e
